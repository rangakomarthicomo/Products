...
class __TwigTemplate_f7e4e34a6ab137870624e5f2729ab35f extends Twig_Template
{
    ...
    {
        // line 3
        $context["__internal_b679be576a3684408869f21a9e82035409f58ebb"] = $this;
        // line 5
...
";
    ...
    ";
        // line 80
        echo $context["__internal_b679be576a3684408869f21a9e82035409f58ebb"]->getdisplay_timeline(("timeline_" . $this->getContext($context, "token")), $this->getAttribute($this->getContext($context, "collector"), "events"), $this->getContext($context, "colors"));
        echo "
    ...
    ";
        ...
        if (twig_length_filter($this->env, $this->getAttribute($this->getContext($context, "profile"), "children"))) {
            ...
            ";
                // line 90
                echo $context["__internal_b679be576a3684408869f21a9e82035409f58ebb"]->getdisplay_timeline(("timeline_" . $this->getAttribute($this->getContext($context, "child"), "token")), $this->getContext($context, "events"), $this->getContext($context, "colors"));
                echo "
        ";
            }
...
";
        // line 406
        echo $context["__internal_b679be576a3684408869f21a9e82035409f58ebb"]->getdump_request_data($this->getContext($context, "token"), $this->getContext($context, "profile"), $this->getAttribute($this->getContext($context, "collector"), "events"), $this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "collector"), "events"), "__section__"), "origin"));
        echo "
...
";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["child"]) {
                // line 411
                echo $context["__internal_b679be576a3684408869f21a9e82035409f58ebb"]->getdump_request_data($this->getAttribute($this->getContext($context, "child"), "token"), $this->getContext($context, "child"), $this->getAttribute($this->getAttribute($this->getContext($context, "child"), "getcollector", array(0 => "time"), "method"), "events"), $this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "collector"), "events"), "__section__"), "origin"));
...
";
    ...
    public function getdump_request_data($_token = null, $_profile = null, $_events = null, $_origin = null)
    {
        ...
        try {
            // line 450
            $context["__internal_8277ce4f3fd8acddc043237a31a5a9bc508fb6fd"] = $this;
            // line 451
            echo "                {
                    \"id\": \"";
            // line 452
...
";
            // line 455
            echo $context["__internal_8277ce4f3fd8acddc043237a31a5a9bc508fb6fd"]->getdump_events($this->getContext($context, "events"));
            echo "
                    ]
                }
";
